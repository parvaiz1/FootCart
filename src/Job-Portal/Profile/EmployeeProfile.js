    ...
    return (
        <>
            <div style={{ display: "flex" }}>
                <p style={{ fontSize: "40px", height: "10px", color: "grey", marginTop: "0px", marginLeft: "50px", cursor: "pointer" }} onClick={() => {
                    navigate(-1)
                }} >&#10229;</p>
                            ...
                            return (
                                <>
                                    ...
                                    <ul className={styles.ulR} key={i}>
                                        ...
                                        {item.isApproved ? <li className={` ${styles.Hli}`} style={{ color: "blue" }}>Congrates! Your account has been Approved, Start posting Jobs</li> : <li className={` ${styles.Hli} ${styles.Nli}`}>"Your account is in under Verfication process"</li>}
                            ...
                            return (
                                <>
                                    <div className={styles.JobCard} key={i}>
                                        ...
                                        <span className={`${styles.span} ${styles.LastDown}`}> Company Address:  {job.CompanyAddress ? <span className={styles.span} style={{ color: "blue" }}  >{job.CompanyAddress} jklkjlldhsdfbfb fjhfkhjdfd gfsgfsfsdf gfgfuysfgsdfgsdf gfhjfkhjdfkjsfsf foisgfosfgodfgsdufgsd gfysgfusdgfysgygf</span> : <span style={{ color: "red" }}>Not updated</span>}</span><br></br>
                                        <span className={`${styles.span} ${styles.LastDown}`}> Account Status:  {job.isApproved ? <span style={{ color: "blue" }}>Congrates! Your account has been Approved, Start posting Jobs</span> : <span style={{ color: "red" }}>"Your account is in under Verfication process"</span>}</span>
                                        </div>
